        ...
        <div className="relative w-fit mx-auto">
            ...
            <div className="absolute bottom-2 left-3 flex items-center gap-2 sm-c:bottom-6 sm-c:left-6">
                <figure className="w-8 h-8 ph-1:w-12 ph-1:h-12 rounded-xl overflow-hidden">
                    <img className="w-full h-full bg-cover" src="https://plus.unsplash.com/premium_photo-1689568126014-06fea9d5d341?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D" alt="" />
                </figure>

                <div className="flex flex-col gap-1">
                    <h1 className="text-[.8rem] ph-1:text-xl">Jonatan Kristoff</h1>
                    <div className="flex items-center gap-1">
                        <figure className="w-5 h-5 ph-1:w-6 ph-1:h-6">
                            <img className="w-full h-full" src="/images/github.png" alt="github" />
                        </figure>
                        <p className="text-[.7rem] ph-1:text-[1rem]">@jontanakroisff</p>
                    </div>
                </div>
            ...
            <p className="rotate-90 absolute right-0 top-1/2 -translate-y-1/2 ph-1:text-2xl">08310#</p>



        </div>

        <button className="w-fit mx-auto py-2 px-5 rounded-full bg-orange-500 text-[.9rem] lg:text-[1rem] cursor-pointer hover:bg-orange-700 transcition-colors duration-300 ease-in-out">Download your ticket</button>
