...
const Title: () => React.JSX.Element = (): React.JSX.Element => {
    ...
    return <article className="text-center flex flex-col gap-2 px-1.5 lg:gap-4">
        ...
        <p className="text-neutral-300 text-[.8rem] sm:text-[1rem] lg:text-xl">We've emailed your ticket to {user?.email ?? "unknown@gmail.com"} and will send updates in the run up to the event.</p>
